...
- The title and adventure menu show the installed version, such as v2.0.0, in small grey text at the bottom left. **Options > About** shows it beside Updates, with the base game version.
